...
modOutputCommands = cms.untracked.vstring()
modOutputCommands.extend(process.RECOSIMEventContent.outputCommands)
modOutputCommands.append('keep *_g4SimHits_*_*')
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #outputCommands = process.RECOSIMEventContent.outputCommands.extend(['keep *_g4SimHits_*_*']),
    outputCommands = modOutputCommands,
